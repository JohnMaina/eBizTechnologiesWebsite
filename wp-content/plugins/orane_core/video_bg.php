...
class Orane_VC_Video_BG {
    function __construct() {
        // We safely integrate with VC with this hook
        add_action( 'init', array( $this, 'integrateWithVC' ) );
 
        // Use this when creating a shortcode addon
        add_shortcode( 'orane_video_bg', array( $this, 'renderPlainHero' ) );
    ...
    public function integrateWithVC() {
        ...
        */
        vc_map( array(
            "name" => __("Video Background", 'orane'),
    ...
    */
    public function renderPlainHero( $atts, $content = null ) {
      ...
      // $youtube_url = vc_extract_youtube_id( $youtube_url );
     
      $output = "<section class='hero-section1 vc_video-bg-container' data-vc-video-bg='{$youtube_url}' data-vc-parallax-image='{$youtube_url}'>
                  <div class='container'>   
                    <div class='col-md-10'>
