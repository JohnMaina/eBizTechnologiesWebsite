...
vc_map( array(
    ...
    "params" => array(
        ...
        array(
            ...
            "holder" => "div",
            "class" => "",
            "heading" => __("Link To A Page", 'vc_extend'),
            "param_name" => "link",
            "description" => __("Optional The Link To The Page.", 'vc_extend')
        ),
...
jQuery.noConflict();
(function( $ ) {
  $('.moving-zone .popup').on('click', function(){
      ...
      <section class='mt-px' style='background-image:url({$img_bg[0]});'>
                    <div class='container'>
         ...
         // $content = wpb_js_remove_wpautop($content, true); // fix unclosed/unwanted paragraph tags in $content
          ...
          $output = "<div class='col-md-4 wow fadeInLeft' data-wow-duration='1s' data-wow-delay='.6s'>
                      <div class='moving-zone'>
                        <div class='popup shadow-1'  data-href=''>
                          <div class='popup-content'>
                            <div class='popup-text'>
                              <h2><a href='{$link}' style='color:#fff'>{$title}</a></h2>
                              <p><a href='{$link}' style='color:#fff'>{$details}</a></p>
                            </div>
                          </div>
                        </div>
                      </div>
